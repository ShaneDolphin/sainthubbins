...
| `internal/core/controls_gen.go` (`// Code generated by tools/gen-controls — DO NOT EDIT.`) | *gone* — see below | `go run ./tools/gen-controls` (currently a no-op) |
...
was right. Regenerating is cheap; verify with a diff against a temp file
before you commit:
