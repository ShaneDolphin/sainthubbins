...
func TestMJS_Port305_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port305_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port305_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
