...
func TestMJS_Port1081_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1081_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1081_HapSpanTimeValueFourth(t *testing.T) {
