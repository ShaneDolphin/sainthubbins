...
func TestMJS_Port1052_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1052_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1052_FastSlowEarlyLateFourth(t *testing.T) {
