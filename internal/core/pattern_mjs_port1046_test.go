...
func TestMJS_Port1046_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1046_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1046_FastSlowEarlyLateFourth(t *testing.T) {
