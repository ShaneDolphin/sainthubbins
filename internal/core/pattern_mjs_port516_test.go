...
func TestMJS_Port516_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port516_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port516_HapSpanTimeValueFourth(t *testing.T) {
