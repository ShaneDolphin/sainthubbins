...
func TestMJS_Port891_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port891_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port891_HapSpanTimeValueFourth(t *testing.T) {
