...
func TestMJS_Port686_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port686_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port686_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
