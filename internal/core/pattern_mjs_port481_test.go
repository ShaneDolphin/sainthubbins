...
func TestMJS_Port481_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port481_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port481_FastSlowEarlyLateFourth(t *testing.T) {
