...
func TestMJS_Port744_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port744_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port744_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
