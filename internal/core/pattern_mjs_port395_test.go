...
func TestMJS_Port395_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port395_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port395_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
