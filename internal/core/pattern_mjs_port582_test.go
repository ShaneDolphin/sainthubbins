...
func TestMJS_Port582_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port582_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port582_FastSlowEarlyLateFourth(t *testing.T) {
