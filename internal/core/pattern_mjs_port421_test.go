...
func TestMJS_Port421_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port421_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port421_FastSlowEarlyLateFourth(t *testing.T) {
