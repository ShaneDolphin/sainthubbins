...
func TestMJS_Port932_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port932_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port932_DegradeOftenRarelySometimesFourth(t *testing.T) {
