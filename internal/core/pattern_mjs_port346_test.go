...
func TestMJS_Port346_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port346_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port346_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
