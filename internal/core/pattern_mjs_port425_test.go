...
func TestMJS_Port425_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port425_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port425_FastSlowEarlyLateFourth(t *testing.T) {
