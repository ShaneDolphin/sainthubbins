...
func TestMJS_Port1022_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1022_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1022_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
