...
func TestMJS_Port1085_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1085_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1085_HapSpanTimeValueFourth(t *testing.T) {
