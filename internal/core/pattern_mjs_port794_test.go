...
func TestMJS_Port794_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port794_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port794_ArpChunkDegradeFourth(t *testing.T) {
