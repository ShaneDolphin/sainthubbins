...
func TestMJS_Port589_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port589_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port589_FastSlowEarlyLateFourth(t *testing.T) {
