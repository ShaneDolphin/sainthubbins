...
func TestMJS_Port382_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port382_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port382_ArpChunkDegradeFourth(t *testing.T) {
