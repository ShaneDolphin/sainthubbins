...
func TestMJS_Port522_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port522_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port522_HapSpanTimeValueFourth(t *testing.T) {
