...
func TestMJS_Port923_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port923_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port923_DegradeOftenRarelySometimesFourth(t *testing.T) {
