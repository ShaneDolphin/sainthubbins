...
func TestMJS_Port379_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port379_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port379_ArpChunkDegradeFourth(t *testing.T) {
