...
func TestMJS_Port879_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port879_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port879_HapSpanTimeValueFourth(t *testing.T) {
