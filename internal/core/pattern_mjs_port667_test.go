...
func TestMJS_Port667_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port667_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port667_DegradeOftenRarelySometimesFourth(t *testing.T) {
