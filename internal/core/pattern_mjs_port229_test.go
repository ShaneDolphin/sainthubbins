...
func TestMJS_Port229_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port229_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port229_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
