...
func TestMJS_Port245_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port245_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port245_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
