...
func TestMJS_Port278_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port278_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port278_HapSpanTimeValueFourth(t *testing.T) {
