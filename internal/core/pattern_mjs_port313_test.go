...
func TestMJS_Port313_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port313_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port313_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
