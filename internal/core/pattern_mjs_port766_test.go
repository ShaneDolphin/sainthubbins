...
func TestMJS_Port766_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port766_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port766_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
