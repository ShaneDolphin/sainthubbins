...
func TestMJS_Port1023_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1023_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1023_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
