...
func TestMJS_Port832_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port832_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port832_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
