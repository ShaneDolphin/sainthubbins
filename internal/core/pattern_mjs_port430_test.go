...
func TestMJS_Port430_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port430_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port430_FastSlowEarlyLateFourth(t *testing.T) {
