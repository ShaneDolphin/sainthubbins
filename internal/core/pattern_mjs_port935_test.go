...
func TestMJS_Port935_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port935_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port935_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
