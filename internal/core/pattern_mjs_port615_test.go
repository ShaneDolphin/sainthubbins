...
func TestMJS_Port615_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port615_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port615_HapSpanTimeValueFourth(t *testing.T) {
