...
func TestMJS_Port1044_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1044_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1044_FastSlowEarlyLateFourth(t *testing.T) {
