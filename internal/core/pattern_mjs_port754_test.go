...
func TestMJS_Port754_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port754_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port754_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
