...
func TestMJS_Port404_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port404_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port404_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
