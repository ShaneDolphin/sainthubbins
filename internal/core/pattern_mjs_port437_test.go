...
func TestMJS_Port437_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port437_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port437_ArpChunkDegradeFourth(t *testing.T) {
