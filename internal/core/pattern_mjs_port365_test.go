...
func TestMJS_Port365_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port365_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port365_HapSpanTimeValueFourth(t *testing.T) {
