...
func TestMJS_Port532_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port532_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port532_HapSpanTimeValueFourth(t *testing.T) {
