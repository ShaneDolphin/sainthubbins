...
func TestMJS_Port252_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port252_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port252_FastSlowEarlyLateFourth(t *testing.T) {
