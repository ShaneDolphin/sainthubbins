...
func TestMJS_Port666_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port666_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port666_DegradeOftenRarelySometimesFourth(t *testing.T) {
