...
func TestMJS_Port244_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port244_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port244_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
