...
func TestMJS_Port931_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port931_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port931_DegradeOftenRarelySometimesFourth(t *testing.T) {
