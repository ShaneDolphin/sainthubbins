...
func TestMJS_Port454_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port454_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port454_ArpChunkDegradeFourth(t *testing.T) {
