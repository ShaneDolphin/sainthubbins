...
func TestMJS_Port934_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port934_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port934_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
