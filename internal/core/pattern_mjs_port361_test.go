...
func TestMJS_Port361_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port361_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port361_HapSpanTimeValueFourth(t *testing.T) {
