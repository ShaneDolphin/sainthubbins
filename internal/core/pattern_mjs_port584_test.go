...
func TestMJS_Port584_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port584_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port584_FastSlowEarlyLateFourth(t *testing.T) {
