...
func TestMJS_Port1012_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1012_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1012_ArpChunkDegradeFourth(t *testing.T) {
