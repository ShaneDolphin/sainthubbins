...
func TestMJS_Port465_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port465_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port465_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
