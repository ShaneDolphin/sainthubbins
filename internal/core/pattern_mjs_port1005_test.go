...
func TestMJS_Port1005_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1005_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1005_ArpChunkDegradeFourth(t *testing.T) {
