...
func TestMJS_Port692_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port692_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port692_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
