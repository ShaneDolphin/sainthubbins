...
func TestMJS_Port688_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port688_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port688_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
