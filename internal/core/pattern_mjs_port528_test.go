...
func TestMJS_Port528_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port528_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port528_HapSpanTimeValueFourth(t *testing.T) {
