...
func TestMJS_Port622_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port622_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port622_HapSpanTimeValueFourth(t *testing.T) {
