...
func TestMJS_Port819_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port819_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port819_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
