...
func TestMJS_Port954_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port954_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port954_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
