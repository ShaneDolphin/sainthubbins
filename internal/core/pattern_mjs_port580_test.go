...
func TestMJS_Port580_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port580_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port580_FastSlowEarlyLateFourth(t *testing.T) {
