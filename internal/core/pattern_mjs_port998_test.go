...
func TestMJS_Port998_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port998_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port998_ArpChunkDegradeFourth(t *testing.T) {
