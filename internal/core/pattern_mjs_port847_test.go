...
func TestMJS_Port847_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port847_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port847_FastSlowEarlyLateFourth(t *testing.T) {
