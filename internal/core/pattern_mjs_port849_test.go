...
func TestMJS_Port849_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port849_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port849_FastSlowEarlyLateFourth(t *testing.T) {
