...
func TestMJS_Port817_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port817_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port817_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
