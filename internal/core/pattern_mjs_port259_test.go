...
func TestMJS_Port259_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port259_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port259_FastSlowEarlyLateFourth(t *testing.T) {
