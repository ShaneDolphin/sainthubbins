...
func TestMJS_Port803_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port803_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port803_ArpChunkDegradeFourth(t *testing.T) {
