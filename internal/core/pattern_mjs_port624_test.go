...
func TestMJS_Port624_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port624_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port624_HapSpanTimeValueFourth(t *testing.T) {
