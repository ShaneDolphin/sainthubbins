...
func TestMJS_Port443_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port443_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port443_ArpChunkDegradeFourth(t *testing.T) {
