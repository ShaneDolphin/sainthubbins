...
func TestMJS_Port995_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port995_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port995_ArpChunkDegradeFourth(t *testing.T) {
