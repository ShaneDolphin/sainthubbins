...
func TestMJS_Port353_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port353_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port353_HapSpanTimeValueFourth(t *testing.T) {
