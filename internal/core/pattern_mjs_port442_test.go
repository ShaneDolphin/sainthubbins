...
func TestMJS_Port442_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port442_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port442_ArpChunkDegradeFourth(t *testing.T) {
