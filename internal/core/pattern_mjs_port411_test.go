...
func TestMJS_Port411_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port411_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port411_FastSlowEarlyLateFourth(t *testing.T) {
