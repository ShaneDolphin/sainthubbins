...
func TestMJS_Port835_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port835_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port835_FastSlowEarlyLateFourth(t *testing.T) {
