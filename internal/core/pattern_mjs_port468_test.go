...
func TestMJS_Port468_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port468_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port468_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
