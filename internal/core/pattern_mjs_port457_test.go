...
func TestMJS_Port457_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port457_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port457_ArpChunkDegradeFourth(t *testing.T) {
