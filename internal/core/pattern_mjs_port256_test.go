...
func TestMJS_Port256_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port256_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port256_FastSlowEarlyLateFourth(t *testing.T) {
