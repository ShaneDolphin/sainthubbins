...
func TestMJS_Port750_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port750_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port750_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
