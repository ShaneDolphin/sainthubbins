...
func TestMJS_Port944_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port944_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port944_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
