...
func TestMJS_Port484_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port484_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port484_FastSlowEarlyLateFourth(t *testing.T) {
