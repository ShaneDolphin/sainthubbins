...
func TestMJS_Port1016_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1016_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1016_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
