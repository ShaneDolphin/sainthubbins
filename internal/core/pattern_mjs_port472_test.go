...
func TestMJS_Port472_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port472_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port472_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
