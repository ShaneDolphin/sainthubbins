...
func TestMJS_Port570_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port570_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port570_DegradeOftenRarelySometimesFourth(t *testing.T) {
