...
func TestMJS_Port563_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port563_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port563_DegradeOftenRarelySometimesFourth(t *testing.T) {
