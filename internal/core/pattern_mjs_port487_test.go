...
func TestMJS_Port487_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port487_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port487_FastSlowEarlyLateFourth(t *testing.T) {
