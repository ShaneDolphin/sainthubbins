...
func TestMJS_Port590_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port590_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port590_FastSlowEarlyLateFourth(t *testing.T) {
