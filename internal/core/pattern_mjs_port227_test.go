...
func TestMJS_Port227_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port227_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port227_DegradeOftenRarelySometimesFourth(t *testing.T) {
