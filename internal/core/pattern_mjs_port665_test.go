...
func TestMJS_Port665_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port665_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port665_DegradeOftenRarelySometimesFourth(t *testing.T) {
