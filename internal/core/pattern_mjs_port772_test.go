...
func TestMJS_Port772_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port772_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port772_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
