...
func TestMJS_Port672_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port672_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port672_DegradeOftenRarelySometimesFourth(t *testing.T) {
