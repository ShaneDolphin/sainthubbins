...
func TestMJS_Port488_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port488_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port488_FastSlowEarlyLateFourth(t *testing.T) {
