...
func TestMJS_Port620_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port620_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port620_HapSpanTimeValueFourth(t *testing.T) {
