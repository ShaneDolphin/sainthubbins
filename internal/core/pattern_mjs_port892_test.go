...
func TestMJS_Port892_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port892_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port892_HapSpanTimeValueFourth(t *testing.T) {
