...
func TestMJS_Port660_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port660_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port660_DegradeOftenRarelySometimesFourth(t *testing.T) {
