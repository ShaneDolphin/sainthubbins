...
func TestMJS_Port209_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port209_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port209_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
