...
func TestMJS_Port1050_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1050_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1050_FastSlowEarlyLateFourth(t *testing.T) {
