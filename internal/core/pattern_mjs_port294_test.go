...
func TestMJS_Port294_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port294_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port294_DegradeOftenRarelySometimesFourth(t *testing.T) {
