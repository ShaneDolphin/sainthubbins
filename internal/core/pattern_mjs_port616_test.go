...
func TestMJS_Port616_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port616_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port616_HapSpanTimeValueFourth(t *testing.T) {
