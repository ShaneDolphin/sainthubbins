...
func TestMJS_Port681_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port681_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port681_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
