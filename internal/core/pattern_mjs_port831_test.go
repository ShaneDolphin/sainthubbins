...
func TestMJS_Port831_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port831_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port831_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
