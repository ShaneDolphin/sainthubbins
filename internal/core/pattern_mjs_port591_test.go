...
func TestMJS_Port591_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port591_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port591_FastSlowEarlyLateFourth(t *testing.T) {
