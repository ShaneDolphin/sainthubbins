...
func TestMJS_Port238_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port238_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port238_ArpChunkDegradeFourth(t *testing.T) {
