...
func TestMJS_Port359_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port359_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port359_HapSpanTimeValueFourth(t *testing.T) {
