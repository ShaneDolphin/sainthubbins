...
func TestMJS_Port825_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port825_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port825_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
