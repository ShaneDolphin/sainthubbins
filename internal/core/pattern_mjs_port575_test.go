...
func TestMJS_Port575_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port575_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port575_FastSlowEarlyLateFourth(t *testing.T) {
