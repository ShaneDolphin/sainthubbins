...
func TestMJS_Port254_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port254_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port254_FastSlowEarlyLateFourth(t *testing.T) {
