...
func TestMJS_Port367_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port367_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port367_HapSpanTimeValueFourth(t *testing.T) {
