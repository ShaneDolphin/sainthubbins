...
func TestMJS_Port881_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port881_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port881_HapSpanTimeValueFourth(t *testing.T) {
