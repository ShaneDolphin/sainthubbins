...
func TestMJS_Port1073_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1073_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1073_HapSpanTimeValueFourth(t *testing.T) {
