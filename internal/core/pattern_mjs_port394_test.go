...
func TestMJS_Port394_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port394_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port394_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
