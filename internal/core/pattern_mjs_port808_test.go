...
func TestMJS_Port808_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port808_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port808_ArpChunkDegradeFourth(t *testing.T) {
