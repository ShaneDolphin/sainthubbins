...
func TestMJS_Port1010_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1010_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1010_ArpChunkDegradeFourth(t *testing.T) {
