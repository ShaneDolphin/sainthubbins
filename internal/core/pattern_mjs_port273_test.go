...
func TestMJS_Port273_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port273_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port273_HapSpanTimeValueFourth(t *testing.T) {
