...
func TestMJS_Port479_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port479_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port479_FastSlowEarlyLateFourth(t *testing.T) {
