...
func TestMJS_Port1048_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1048_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1048_FastSlowEarlyLateFourth(t *testing.T) {
