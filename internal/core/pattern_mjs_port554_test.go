...
func TestMJS_Port554_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port554_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port554_DegradeOftenRarelySometimesFourth(t *testing.T) {
