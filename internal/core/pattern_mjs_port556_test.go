...
func TestMJS_Port556_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port556_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port556_DegradeOftenRarelySometimesFourth(t *testing.T) {
