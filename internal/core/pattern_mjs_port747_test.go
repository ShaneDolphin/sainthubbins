...
func TestMJS_Port747_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port747_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port747_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
