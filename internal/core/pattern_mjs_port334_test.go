...
func TestMJS_Port334_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port334_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port334_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
