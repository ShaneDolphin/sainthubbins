...
func TestMJS_Port490_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port490_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port490_FastSlowEarlyLateFourth(t *testing.T) {
