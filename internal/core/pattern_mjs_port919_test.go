...
func TestMJS_Port919_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port919_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port919_DegradeOftenRarelySometimesFourth(t *testing.T) {
