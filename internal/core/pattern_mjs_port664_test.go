...
func TestMJS_Port664_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port664_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port664_DegradeOftenRarelySometimesFourth(t *testing.T) {
