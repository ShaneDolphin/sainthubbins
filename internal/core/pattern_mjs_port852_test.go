...
func TestMJS_Port852_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port852_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port852_FastSlowEarlyLateFourth(t *testing.T) {
