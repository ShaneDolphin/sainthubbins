...
func TestMJS_Port462_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port462_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port462_ArpChunkDegradeFourth(t *testing.T) {
