...
func TestMJS_Port999_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port999_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port999_ArpChunkDegradeFourth(t *testing.T) {
