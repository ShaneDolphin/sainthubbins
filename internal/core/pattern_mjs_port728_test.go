...
func TestMJS_Port728_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port728_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port728_DegradeOftenRarelySometimesFourth(t *testing.T) {
