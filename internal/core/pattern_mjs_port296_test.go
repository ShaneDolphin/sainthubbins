...
func TestMJS_Port296_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port296_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port296_DegradeOftenRarelySometimesFourth(t *testing.T) {
