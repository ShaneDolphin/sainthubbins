...
func TestMJS_Port1051_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1051_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1051_FastSlowEarlyLateFourth(t *testing.T) {
