...
func TestMJS_Port341_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port341_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port341_FastSlowEarlyLateFourth(t *testing.T) {
