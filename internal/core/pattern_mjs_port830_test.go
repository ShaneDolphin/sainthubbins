...
func TestMJS_Port830_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port830_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port830_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
