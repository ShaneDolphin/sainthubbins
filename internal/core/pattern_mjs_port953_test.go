...
func TestMJS_Port953_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port953_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port953_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
