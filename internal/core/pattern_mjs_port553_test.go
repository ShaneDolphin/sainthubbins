...
func TestMJS_Port553_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port553_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port553_DegradeOftenRarelySometimesFourth(t *testing.T) {
