...
func TestMJS_Port248_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port248_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port248_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
