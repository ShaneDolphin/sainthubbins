...
func TestMJS_Port1087_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1087_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1087_HapSpanTimeValueFourth(t *testing.T) {
