...
func TestMJS_Port413_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port413_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port413_FastSlowEarlyLateFourth(t *testing.T) {
