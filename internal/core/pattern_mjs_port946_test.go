...
func TestMJS_Port946_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port946_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port946_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
