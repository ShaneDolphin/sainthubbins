...
func TestMJS_Port748_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port748_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port748_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
