...
func TestMJS_Port878_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port878_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port878_HapSpanTimeValueFourth(t *testing.T) {
