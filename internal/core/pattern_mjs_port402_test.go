...
func TestMJS_Port402_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port402_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port402_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
