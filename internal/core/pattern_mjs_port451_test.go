...
func TestMJS_Port451_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port451_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port451_ArpChunkDegradeFourth(t *testing.T) {
