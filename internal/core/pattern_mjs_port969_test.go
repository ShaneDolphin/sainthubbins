...
func TestMJS_Port969_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port969_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port969_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
