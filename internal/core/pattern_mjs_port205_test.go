...
func TestMJS_Port205_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port205_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port205_HapSpanTimeValueFourth(t *testing.T) {
