...
func TestMJS_Port619_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port619_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port619_HapSpanTimeValueFourth(t *testing.T) {
