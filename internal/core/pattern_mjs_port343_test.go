...
func TestMJS_Port343_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port343_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port343_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
