...
func TestMJS_Port424_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port424_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port424_FastSlowEarlyLateFourth(t *testing.T) {
