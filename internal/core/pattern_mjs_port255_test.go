...
func TestMJS_Port255_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port255_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port255_FastSlowEarlyLateFourth(t *testing.T) {
