...
func TestMJS_Port722_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port722_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port722_DegradeOftenRarelySometimesFourth(t *testing.T) {
