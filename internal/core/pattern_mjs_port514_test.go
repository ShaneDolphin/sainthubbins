...
func TestMJS_Port514_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port514_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port514_HapSpanTimeValueFourth(t *testing.T) {
