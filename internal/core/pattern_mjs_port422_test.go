...
func TestMJS_Port422_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port422_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port422_FastSlowEarlyLateFourth(t *testing.T) {
