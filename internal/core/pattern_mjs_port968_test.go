...
func TestMJS_Port968_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port968_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port968_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
