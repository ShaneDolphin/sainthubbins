...
func TestMJS_Port476_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port476_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port476_FastSlowEarlyLateFourth(t *testing.T) {
