...
func TestMJS_Port943_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port943_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port943_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
