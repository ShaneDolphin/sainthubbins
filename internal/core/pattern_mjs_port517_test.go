...
func TestMJS_Port517_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port517_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port517_HapSpanTimeValueFourth(t *testing.T) {
