...
func TestMJS_Port432_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port432_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port432_ArpChunkDegradeFourth(t *testing.T) {
