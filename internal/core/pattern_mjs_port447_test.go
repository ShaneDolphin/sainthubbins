...
func TestMJS_Port447_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port447_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port447_ArpChunkDegradeFourth(t *testing.T) {
