...
func TestMJS_Port485_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port485_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port485_FastSlowEarlyLateFourth(t *testing.T) {
