...
func TestMJS_Port740_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port740_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port740_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
