...
func TestMJS_Port970_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port970_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port970_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
