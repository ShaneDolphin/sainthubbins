...
func TestMJS_Port332_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port332_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port332_FastSlowEarlyLateFourth(t *testing.T) {
