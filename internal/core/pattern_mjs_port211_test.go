...
func TestMJS_Port211_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port211_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port211_ArpChunkDegradeFourth(t *testing.T) {
