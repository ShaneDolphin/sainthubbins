...
func TestMJS_Port732_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port732_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port732_DegradeOftenRarelySometimesFourth(t *testing.T) {
