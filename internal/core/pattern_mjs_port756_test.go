...
func TestMJS_Port756_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port756_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port756_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
