...
func TestMJS_Port873_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port873_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port873_HapSpanTimeValueFourth(t *testing.T) {
