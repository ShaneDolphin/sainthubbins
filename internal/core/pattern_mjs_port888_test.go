...
func TestMJS_Port888_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port888_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port888_HapSpanTimeValueFourth(t *testing.T) {
