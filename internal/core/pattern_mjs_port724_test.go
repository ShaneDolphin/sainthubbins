...
func TestMJS_Port724_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port724_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port724_DegradeOftenRarelySometimesFourth(t *testing.T) {
