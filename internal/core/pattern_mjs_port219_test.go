...
func TestMJS_Port219_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port219_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port219_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
