...
func TestMJS_Port355_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port355_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port355_HapSpanTimeValueFourth(t *testing.T) {
