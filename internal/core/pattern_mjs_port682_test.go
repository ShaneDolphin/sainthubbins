...
func TestMJS_Port682_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port682_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port682_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
