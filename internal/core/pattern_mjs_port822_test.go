...
func TestMJS_Port822_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port822_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port822_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
