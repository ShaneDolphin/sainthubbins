...
func TestMJS_Port521_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port521_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port521_HapSpanTimeValueFourth(t *testing.T) {
