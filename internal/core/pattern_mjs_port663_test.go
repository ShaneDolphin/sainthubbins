...
func TestMJS_Port663_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port663_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port663_DegradeOftenRarelySometimesFourth(t *testing.T) {
