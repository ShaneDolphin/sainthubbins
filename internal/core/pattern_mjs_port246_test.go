...
func TestMJS_Port246_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port246_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port246_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
