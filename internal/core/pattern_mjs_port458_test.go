...
func TestMJS_Port458_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port458_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port458_ArpChunkDegradeFourth(t *testing.T) {
