...
func TestMJS_Port655_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port655_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port655_DegradeOftenRarelySometimesFourth(t *testing.T) {
