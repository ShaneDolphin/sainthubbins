...
func TestMJS_Port529_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port529_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port529_HapSpanTimeValueFourth(t *testing.T) {
