...
func TestMJS_Port581_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port581_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port581_FastSlowEarlyLateFourth(t *testing.T) {
