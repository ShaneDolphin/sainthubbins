...
func TestMJS_Port587_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port587_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port587_FastSlowEarlyLateFourth(t *testing.T) {
