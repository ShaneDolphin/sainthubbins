...
func TestMJS_Port1078_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1078_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1078_HapSpanTimeValueFourth(t *testing.T) {
