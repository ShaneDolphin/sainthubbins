...
func TestMJS_Port247_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port247_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port247_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
