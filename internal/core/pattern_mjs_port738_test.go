...
func TestMJS_Port738_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port738_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port738_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
