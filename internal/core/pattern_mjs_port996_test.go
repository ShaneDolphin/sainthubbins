...
func TestMJS_Port996_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port996_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port996_ArpChunkDegradeFourth(t *testing.T) {
