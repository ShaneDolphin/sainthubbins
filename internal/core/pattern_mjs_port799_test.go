...
func TestMJS_Port799_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port799_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port799_ArpChunkDegradeFourth(t *testing.T) {
