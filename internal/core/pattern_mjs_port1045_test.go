...
func TestMJS_Port1045_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1045_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1045_FastSlowEarlyLateFourth(t *testing.T) {
