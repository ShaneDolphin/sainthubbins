...
func TestMJS_Port444_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port444_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port444_ArpChunkDegradeFourth(t *testing.T) {
