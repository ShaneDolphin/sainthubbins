...
func TestMJS_Port298_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port298_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port298_DegradeOftenRarelySometimesFourth(t *testing.T) {
