...
func TestMJS_Port671_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port671_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port671_DegradeOftenRarelySometimesFourth(t *testing.T) {
