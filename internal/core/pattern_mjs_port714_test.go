...
func TestMJS_Port714_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port714_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port714_DegradeOftenRarelySometimesFourth(t *testing.T) {
