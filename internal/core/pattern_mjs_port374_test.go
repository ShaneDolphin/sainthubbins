...
func TestMJS_Port374_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port374_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port374_ArpChunkDegradeFourth(t *testing.T) {
