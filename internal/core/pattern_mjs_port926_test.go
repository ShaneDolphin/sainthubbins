...
func TestMJS_Port926_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port926_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port926_DegradeOftenRarelySometimesFourth(t *testing.T) {
