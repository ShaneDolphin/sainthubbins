...
func TestMJS_Port272_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port272_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port272_HapSpanTimeValueFourth(t *testing.T) {
