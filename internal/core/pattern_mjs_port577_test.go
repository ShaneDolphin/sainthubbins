...
func TestMJS_Port577_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port577_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port577_FastSlowEarlyLateFourth(t *testing.T) {
