...
func TestMJS_Port303_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port303_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port303_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
