...
func TestMJS_Port1074_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1074_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1074_HapSpanTimeValueFourth(t *testing.T) {
