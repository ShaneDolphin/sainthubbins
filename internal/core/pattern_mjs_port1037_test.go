...
func TestMJS_Port1037_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1037_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1037_FastSlowEarlyLateFourth(t *testing.T) {
