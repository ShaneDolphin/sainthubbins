...
func TestMJS_Port383_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port383_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port383_ArpChunkDegradeFourth(t *testing.T) {
