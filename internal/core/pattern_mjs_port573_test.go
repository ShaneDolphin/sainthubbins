...
func TestMJS_Port573_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port573_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port573_FastSlowEarlyLateFourth(t *testing.T) {
