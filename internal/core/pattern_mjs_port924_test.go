...
func TestMJS_Port924_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port924_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port924_DegradeOftenRarelySometimesFourth(t *testing.T) {
