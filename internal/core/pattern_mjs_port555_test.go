...
func TestMJS_Port555_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port555_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port555_DegradeOftenRarelySometimesFourth(t *testing.T) {
