...
func TestMJS_Port1080_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1080_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1080_HapSpanTimeValueFourth(t *testing.T) {
