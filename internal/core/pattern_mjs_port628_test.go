...
func TestMJS_Port628_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port628_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port628_HapSpanTimeValueFourth(t *testing.T) {
