...
func TestMJS_Port473_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port473_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port473_FastSlowEarlyLateFourth(t *testing.T) {
