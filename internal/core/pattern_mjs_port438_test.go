...
func TestMJS_Port438_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port438_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port438_ArpChunkDegradeFourth(t *testing.T) {
