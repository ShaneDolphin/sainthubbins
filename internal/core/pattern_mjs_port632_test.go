...
func TestMJS_Port632_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port632_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port632_HapSpanTimeValueFourth(t *testing.T) {
