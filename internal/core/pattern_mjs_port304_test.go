...
func TestMJS_Port304_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port304_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port304_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
