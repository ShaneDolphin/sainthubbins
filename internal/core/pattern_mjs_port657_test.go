...
func TestMJS_Port657_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port657_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port657_DegradeOftenRarelySometimesFourth(t *testing.T) {
