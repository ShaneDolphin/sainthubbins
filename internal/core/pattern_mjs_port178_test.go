...
func TestMJS_Port178_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port178_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port178_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
