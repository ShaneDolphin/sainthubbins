...
func TestMJS_Port673_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port673_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port673_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
