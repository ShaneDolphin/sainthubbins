...
func TestMJS_Port491_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port491_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port491_FastSlowEarlyLateFourth(t *testing.T) {
