...
func TestMJS_Port1086_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1086_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1086_HapSpanTimeValueFourth(t *testing.T) {
