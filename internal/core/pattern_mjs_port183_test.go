...
func TestMJS_Port183_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port183_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port183_DegradeOftenRarelySometimesFourth(t *testing.T) {
