...
func TestMJS_Port723_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port723_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port723_DegradeOftenRarelySometimesFourth(t *testing.T) {
