...
func TestMJS_Port453_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port453_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port453_ArpChunkDegradeFourth(t *testing.T) {
