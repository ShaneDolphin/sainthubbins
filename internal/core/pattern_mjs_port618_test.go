...
func TestMJS_Port618_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port618_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port618_HapSpanTimeValueFourth(t *testing.T) {
