...
func TestMJS_Port1076_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1076_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1076_HapSpanTimeValueFourth(t *testing.T) {
