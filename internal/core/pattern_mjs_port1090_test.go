...
func TestMJS_Port1090_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1090_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1090_HapSpanTimeValueFourth(t *testing.T) {
