...
func TestMJS_Port418_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port418_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port418_FastSlowEarlyLateFourth(t *testing.T) {
