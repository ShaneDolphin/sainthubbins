...
func TestMJS_Port940_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port940_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port940_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
