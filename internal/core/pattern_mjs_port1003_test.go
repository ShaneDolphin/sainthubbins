...
func TestMJS_Port1003_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1003_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1003_ArpChunkDegradeFourth(t *testing.T) {
