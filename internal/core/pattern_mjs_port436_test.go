...
func TestMJS_Port436_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port436_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port436_ArpChunkDegradeFourth(t *testing.T) {
