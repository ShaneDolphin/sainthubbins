...
func TestMJS_Port381_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port381_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port381_ArpChunkDegradeFourth(t *testing.T) {
