...
func TestMJS_Port384_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port384_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port384_ArpChunkDegradeFourth(t *testing.T) {
