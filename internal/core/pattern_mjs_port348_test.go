...
func TestMJS_Port348_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port348_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port348_ArpChunkDegradeFourth(t *testing.T) {
