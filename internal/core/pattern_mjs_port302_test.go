...
func TestMJS_Port302_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port302_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port302_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
