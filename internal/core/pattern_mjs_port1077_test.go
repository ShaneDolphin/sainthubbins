...
func TestMJS_Port1077_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1077_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1077_HapSpanTimeValueFourth(t *testing.T) {
