...
func TestMJS_Port1002_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1002_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1002_ArpChunkDegradeFourth(t *testing.T) {
