...
func TestMJS_Port1015_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1015_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1015_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
