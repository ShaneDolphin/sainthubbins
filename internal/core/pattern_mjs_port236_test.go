...
func TestMJS_Port236_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port236_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port236_ArpChunkDegradeFourth(t *testing.T) {
