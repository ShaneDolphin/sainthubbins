...
func TestMJS_Port376_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port376_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port376_ArpChunkDegradeFourth(t *testing.T) {
