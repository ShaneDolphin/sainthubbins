...
func TestMJS_Port525_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port525_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port525_HapSpanTimeValueFourth(t *testing.T) {
