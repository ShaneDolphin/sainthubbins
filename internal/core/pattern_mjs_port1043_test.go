...
func TestMJS_Port1043_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1043_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1043_FastSlowEarlyLateFourth(t *testing.T) {
