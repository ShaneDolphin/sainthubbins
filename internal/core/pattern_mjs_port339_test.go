...
func TestMJS_Port339_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port339_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port339_ArpChunkDegradeFourth(t *testing.T) {
