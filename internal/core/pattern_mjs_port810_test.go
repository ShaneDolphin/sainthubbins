...
func TestMJS_Port810_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port810_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port810_ArpChunkDegradeFourth(t *testing.T) {
