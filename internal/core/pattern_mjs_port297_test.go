...
func TestMJS_Port297_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port297_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port297_DegradeOftenRarelySometimesFourth(t *testing.T) {
