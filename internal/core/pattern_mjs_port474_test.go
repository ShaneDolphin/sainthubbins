...
func TestMJS_Port474_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port474_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port474_FastSlowEarlyLateFourth(t *testing.T) {
