...
func TestMJS_Port426_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port426_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port426_FastSlowEarlyLateFourth(t *testing.T) {
