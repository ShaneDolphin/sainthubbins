...
func TestMJS_Port562_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port562_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port562_DegradeOftenRarelySometimesFourth(t *testing.T) {
