...
func TestMJS_Port880_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port880_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port880_HapSpanTimeValueFourth(t *testing.T) {
