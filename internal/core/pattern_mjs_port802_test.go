...
func TestMJS_Port802_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port802_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port802_ArpChunkDegradeFourth(t *testing.T) {
