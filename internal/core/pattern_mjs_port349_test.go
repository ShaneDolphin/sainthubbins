...
func TestMJS_Port349_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port349_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
