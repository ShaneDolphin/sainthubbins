...
func TestMJS_Port470_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port470_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port470_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
