...
func TestMJS_Port228_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port228_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port228_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
