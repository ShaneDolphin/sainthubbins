...
func TestMJS_Port994_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port994_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port994_ArpChunkDegradeFourth(t *testing.T) {
