...
func TestMJS_Port1079_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1079_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1079_HapSpanTimeValueFourth(t *testing.T) {
