...
func TestMJS_Port417_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port417_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port417_FastSlowEarlyLateFourth(t *testing.T) {
