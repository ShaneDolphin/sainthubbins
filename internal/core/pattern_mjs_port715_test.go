...
func TestMJS_Port715_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port715_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port715_DegradeOftenRarelySometimesFourth(t *testing.T) {
