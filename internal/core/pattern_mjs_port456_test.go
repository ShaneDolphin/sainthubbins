...
func TestMJS_Port456_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port456_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port456_ArpChunkDegradeFourth(t *testing.T) {
