...
func TestMJS_Port930_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port930_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port930_DegradeOftenRarelySometimesFourth(t *testing.T) {
