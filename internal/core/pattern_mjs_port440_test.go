...
func TestMJS_Port440_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port440_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port440_ArpChunkDegradeFourth(t *testing.T) {
