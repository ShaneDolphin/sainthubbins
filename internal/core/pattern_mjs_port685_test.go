...
func TestMJS_Port685_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port685_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port685_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
