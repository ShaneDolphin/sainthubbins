...
func TestMJS_Port375_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port375_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port375_ArpChunkDegradeFourth(t *testing.T) {
