...
func TestMJS_Port877_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port877_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port877_HapSpanTimeValueFourth(t *testing.T) {
