...
func TestMJS_Port449_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port449_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port449_ArpChunkDegradeFourth(t *testing.T) {
