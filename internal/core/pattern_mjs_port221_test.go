...
func TestMJS_Port221_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port221_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port221_ArpChunkDegradeFourth(t *testing.T) {
