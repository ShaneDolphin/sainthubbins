...
func TestMJS_Port231_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port231_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port231_ArpChunkDegradeFourth(t *testing.T) {
