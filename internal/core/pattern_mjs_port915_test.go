...
func TestMJS_Port915_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port915_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port915_DegradeOftenRarelySometimesFourth(t *testing.T) {
