...
func TestMJS_Port345_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port345_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port345_ArpChunkDegradeFourth(t *testing.T) {
