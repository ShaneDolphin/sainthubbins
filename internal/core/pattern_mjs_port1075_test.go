...
func TestMJS_Port1075_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1075_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1075_HapSpanTimeValueFourth(t *testing.T) {
