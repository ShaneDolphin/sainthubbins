...
func TestMJS_Port467_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port467_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port467_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
