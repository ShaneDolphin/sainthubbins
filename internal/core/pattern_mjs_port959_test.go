...
func TestMJS_Port959_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port959_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port959_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
