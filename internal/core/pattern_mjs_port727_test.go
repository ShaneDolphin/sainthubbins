...
func TestMJS_Port727_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port727_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port727_DegradeOftenRarelySometimesFourth(t *testing.T) {
