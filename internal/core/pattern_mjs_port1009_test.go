...
func TestMJS_Port1009_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1009_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1009_ArpChunkDegradeFourth(t *testing.T) {
