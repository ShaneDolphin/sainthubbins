...
func TestMJS_Port409_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port409_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port409_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
