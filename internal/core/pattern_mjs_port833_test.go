...
func TestMJS_Port833_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port833_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port833_FastSlowEarlyLateFourth(t *testing.T) {
