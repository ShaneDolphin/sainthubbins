...
func TestMJS_Port428_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port428_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port428_FastSlowEarlyLateFourth(t *testing.T) {
