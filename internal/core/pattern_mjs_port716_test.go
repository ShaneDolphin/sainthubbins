...
func TestMJS_Port716_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port716_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port716_DegradeOftenRarelySometimesFourth(t *testing.T) {
