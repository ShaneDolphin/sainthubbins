...
func TestMJS_Port401_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port401_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port401_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
