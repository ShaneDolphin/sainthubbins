...
func TestMJS_Port392_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port392_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port392_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
