...
func TestMJS_Port233_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port233_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port233_ArpChunkDegradeFourth(t *testing.T) {
