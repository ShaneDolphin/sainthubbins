...
func TestMJS_Port614_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port614_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port614_HapSpanTimeValueFourth(t *testing.T) {
