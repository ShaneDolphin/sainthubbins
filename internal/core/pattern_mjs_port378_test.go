...
func TestMJS_Port378_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port378_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port378_ArpChunkDegradeFourth(t *testing.T) {
