...
func TestMJS_Port834_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port834_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port834_FastSlowEarlyLateFourth(t *testing.T) {
