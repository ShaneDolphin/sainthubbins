...
func TestMJS_Port752_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port752_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port752_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
