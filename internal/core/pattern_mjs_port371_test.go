...
func TestMJS_Port371_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port371_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port371_ArpChunkDegradeFourth(t *testing.T) {
