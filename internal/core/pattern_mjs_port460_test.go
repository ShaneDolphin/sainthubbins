...
func TestMJS_Port460_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port460_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port460_ArpChunkDegradeFourth(t *testing.T) {
