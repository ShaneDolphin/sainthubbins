...
func TestMJS_Port513_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port513_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port513_HapSpanTimeValueFourth(t *testing.T) {
