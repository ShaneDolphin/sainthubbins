...
func TestMJS_Port749_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port749_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port749_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
