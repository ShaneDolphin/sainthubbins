...
func TestMJS_Port475_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port475_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port475_FastSlowEarlyLateFourth(t *testing.T) {
