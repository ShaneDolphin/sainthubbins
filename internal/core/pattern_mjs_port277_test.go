...
func TestMJS_Port277_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port277_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port277_HapSpanTimeValueFourth(t *testing.T) {
