...
func TestMJS_Port477_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port477_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port477_FastSlowEarlyLateFourth(t *testing.T) {
