...
func TestMJS_Port492_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port492_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port492_FastSlowEarlyLateFourth(t *testing.T) {
