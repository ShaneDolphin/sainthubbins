...
func TestMJS_Port1024_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1024_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1024_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
