...
func TestMJS_Port291_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port291_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port291_DegradeOftenRarelySometimesFourth(t *testing.T) {
