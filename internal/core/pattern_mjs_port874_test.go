...
func TestMJS_Port874_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port874_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port874_HapSpanTimeValueFourth(t *testing.T) {
