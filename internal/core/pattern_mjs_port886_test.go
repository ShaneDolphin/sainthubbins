...
func TestMJS_Port886_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port886_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port886_HapSpanTimeValueFourth(t *testing.T) {
