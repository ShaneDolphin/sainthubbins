...
func TestMJS_Port415_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port415_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port415_FastSlowEarlyLateFourth(t *testing.T) {
