...
func TestMJS_Port807_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port807_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port807_ArpChunkDegradeFourth(t *testing.T) {
