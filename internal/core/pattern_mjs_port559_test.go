...
func TestMJS_Port559_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port559_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port559_DegradeOftenRarelySometimesFourth(t *testing.T) {
