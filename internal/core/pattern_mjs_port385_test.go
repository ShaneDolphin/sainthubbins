...
func TestMJS_Port385_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port385_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port385_ArpChunkDegradeFourth(t *testing.T) {
