...
func TestMJS_Port435_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port435_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port435_ArpChunkDegradeFourth(t *testing.T) {
