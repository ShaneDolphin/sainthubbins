...
func TestMJS_Port588_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port588_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port588_FastSlowEarlyLateFourth(t *testing.T) {
