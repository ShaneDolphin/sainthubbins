...
func TestMJS_Port441_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port441_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port441_ArpChunkDegradeFourth(t *testing.T) {
