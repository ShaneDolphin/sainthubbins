...
func TestMJS_Port531_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port531_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port531_HapSpanTimeValueFourth(t *testing.T) {
