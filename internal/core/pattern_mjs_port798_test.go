...
func TestMJS_Port798_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port798_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port798_ArpChunkDegradeFourth(t *testing.T) {
