...
func TestMJS_Port938_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port938_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port938_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
