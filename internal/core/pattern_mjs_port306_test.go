...
func TestMJS_Port306_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port306_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port306_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
