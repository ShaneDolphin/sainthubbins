...
func TestMJS_Port971_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port971_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port971_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
