...
func TestMJS_Port842_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port842_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port842_FastSlowEarlyLateFourth(t *testing.T) {
