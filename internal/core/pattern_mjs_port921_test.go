...
func TestMJS_Port921_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port921_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port921_DegradeOftenRarelySometimesFourth(t *testing.T) {
