...
func TestMJS_Port806_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port806_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port806_ArpChunkDegradeFourth(t *testing.T) {
