...
func TestMJS_Port629_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port629_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port629_HapSpanTimeValueFourth(t *testing.T) {
