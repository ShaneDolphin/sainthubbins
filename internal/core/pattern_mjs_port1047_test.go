...
func TestMJS_Port1047_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1047_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1047_FastSlowEarlyLateFourth(t *testing.T) {
