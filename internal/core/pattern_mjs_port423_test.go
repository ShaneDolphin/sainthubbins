...
func TestMJS_Port423_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port423_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port423_FastSlowEarlyLateFourth(t *testing.T) {
