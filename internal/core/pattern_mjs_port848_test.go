...
func TestMJS_Port848_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port848_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port848_FastSlowEarlyLateFourth(t *testing.T) {
