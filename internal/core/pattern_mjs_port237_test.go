...
func TestMJS_Port237_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port237_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port237_ArpChunkDegradeFourth(t *testing.T) {
