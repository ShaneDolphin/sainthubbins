...
func TestMJS_Port483_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port483_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port483_FastSlowEarlyLateFourth(t *testing.T) {
