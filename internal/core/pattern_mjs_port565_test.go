...
func TestMJS_Port565_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port565_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port565_DegradeOftenRarelySometimesFourth(t *testing.T) {
