...
func TestMJS_Port1032_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1032_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1032_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
