...
func TestMJS_Port583_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port583_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port583_FastSlowEarlyLateFourth(t *testing.T) {
