...
func TestMJS_Port1082_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1082_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1082_HapSpanTimeValueFourth(t *testing.T) {
