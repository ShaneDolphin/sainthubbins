...
func TestMJS_Port929_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port929_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port929_DegradeOftenRarelySometimesFourth(t *testing.T) {
