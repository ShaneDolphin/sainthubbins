...
func TestMJS_Port412_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port412_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port412_FastSlowEarlyLateFourth(t *testing.T) {
