...
func TestMJS_Port373_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port373_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port373_ArpChunkDegradeFourth(t *testing.T) {
