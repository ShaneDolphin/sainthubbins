...
func TestMJS_Port515_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port515_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port515_HapSpanTimeValueFourth(t *testing.T) {
