...
func TestMJS_Port567_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port567_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port567_DegradeOftenRarelySometimesFourth(t *testing.T) {
