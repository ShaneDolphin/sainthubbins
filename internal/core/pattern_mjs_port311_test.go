...
func TestMJS_Port311_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port311_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port311_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
