...
func TestMJS_Port386_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port386_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port386_ArpChunkDegradeFourth(t *testing.T) {
