...
func TestMJS_Port576_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port576_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port576_FastSlowEarlyLateFourth(t *testing.T) {
