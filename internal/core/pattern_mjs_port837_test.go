...
func TestMJS_Port837_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port837_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port837_FastSlowEarlyLateFourth(t *testing.T) {
