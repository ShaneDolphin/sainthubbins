...
func TestMJS_Port883_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port883_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port883_HapSpanTimeValueFourth(t *testing.T) {
