...
func TestMJS_Port731_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port731_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port731_DegradeOftenRarelySometimesFourth(t *testing.T) {
