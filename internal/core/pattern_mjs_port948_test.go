...
func TestMJS_Port948_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port948_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port948_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
