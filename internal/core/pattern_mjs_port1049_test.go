...
func TestMJS_Port1049_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1049_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1049_FastSlowEarlyLateFourth(t *testing.T) {
