...
func TestMJS_Port962_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port962_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port962_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
