...
func TestMJS_Port480_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port480_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port480_FastSlowEarlyLateFourth(t *testing.T) {
