...
func TestMJS_Port1084_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1084_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1084_HapSpanTimeValueFourth(t *testing.T) {
