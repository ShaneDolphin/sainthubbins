...
func TestMJS_Port922_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port922_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port922_DegradeOftenRarelySometimesFourth(t *testing.T) {
