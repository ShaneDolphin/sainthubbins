...
func TestMJS_Port1004_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1004_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1004_ArpChunkDegradeFourth(t *testing.T) {
