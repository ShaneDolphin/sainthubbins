...
func TestMJS_Port626_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port626_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port626_HapSpanTimeValueFourth(t *testing.T) {
