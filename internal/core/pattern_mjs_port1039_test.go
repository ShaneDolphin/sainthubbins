...
func TestMJS_Port1039_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1039_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1039_FastSlowEarlyLateFourth(t *testing.T) {
