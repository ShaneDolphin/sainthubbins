...
func TestMJS_Port518_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port518_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port518_HapSpanTimeValueFourth(t *testing.T) {
