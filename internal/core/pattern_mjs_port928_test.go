...
func TestMJS_Port928_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port928_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port928_DegradeOftenRarelySometimesFourth(t *testing.T) {
