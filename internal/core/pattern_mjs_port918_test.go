...
func TestMJS_Port918_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port918_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port918_DegradeOftenRarelySometimesFourth(t *testing.T) {
