...
func TestMJS_Port828_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port828_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port828_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
