...
func TestMJS_Port890_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port890_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port890_HapSpanTimeValueFourth(t *testing.T) {
