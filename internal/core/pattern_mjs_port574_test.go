...
func TestMJS_Port574_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port574_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port574_FastSlowEarlyLateFourth(t *testing.T) {
