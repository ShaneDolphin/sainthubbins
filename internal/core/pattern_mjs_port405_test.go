...
func TestMJS_Port405_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port405_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port405_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
