...
func TestMJS_Port885_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port885_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port885_HapSpanTimeValueFourth(t *testing.T) {
