...
func TestMJS_Port295_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port295_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port295_DegradeOftenRarelySometimesFourth(t *testing.T) {
