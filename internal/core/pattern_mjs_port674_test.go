...
func TestMJS_Port674_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port674_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port674_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
