...
func TestMJS_Port523_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port523_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port523_HapSpanTimeValueFourth(t *testing.T) {
