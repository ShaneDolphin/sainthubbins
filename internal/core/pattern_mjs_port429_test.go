...
func TestMJS_Port429_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port429_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port429_FastSlowEarlyLateFourth(t *testing.T) {
