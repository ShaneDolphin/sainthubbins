...
func TestMJS_Port260_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port260_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port260_FastSlowEarlyLateFourth(t *testing.T) {
