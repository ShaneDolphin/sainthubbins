...
func TestMJS_Port993_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port993_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port993_ArpChunkDegradeFourth(t *testing.T) {
