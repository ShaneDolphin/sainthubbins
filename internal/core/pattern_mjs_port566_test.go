...
func TestMJS_Port566_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port566_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port566_DegradeOftenRarelySometimesFourth(t *testing.T) {
