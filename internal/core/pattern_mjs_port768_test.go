...
func TestMJS_Port768_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port768_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port768_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
