...
func TestMJS_Port767_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port767_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port767_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
