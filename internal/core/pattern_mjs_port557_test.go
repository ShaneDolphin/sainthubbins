...
func TestMJS_Port557_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port557_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port557_DegradeOftenRarelySometimesFourth(t *testing.T) {
