...
func TestMJS_Port670_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port670_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port670_DegradeOftenRarelySometimesFourth(t *testing.T) {
