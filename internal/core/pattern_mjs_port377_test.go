...
func TestMJS_Port377_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port377_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port377_ArpChunkDegradeFourth(t *testing.T) {
