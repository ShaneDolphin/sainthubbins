...
func TestMJS_Port876_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port876_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port876_HapSpanTimeValueFourth(t *testing.T) {
