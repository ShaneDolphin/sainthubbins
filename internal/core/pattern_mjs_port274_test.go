...
func TestMJS_Port274_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port274_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port274_HapSpanTimeValueFourth(t *testing.T) {
