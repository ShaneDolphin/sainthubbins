...
func TestMJS_Port690_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port690_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port690_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
