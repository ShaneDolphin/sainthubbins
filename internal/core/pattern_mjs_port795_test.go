...
func TestMJS_Port795_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port795_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port795_ArpChunkDegradeFourth(t *testing.T) {
