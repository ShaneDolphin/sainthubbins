...
func TestMJS_Port363_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port363_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port363_HapSpanTimeValueFourth(t *testing.T) {
