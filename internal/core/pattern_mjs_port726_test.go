...
func TestMJS_Port726_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port726_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port726_DegradeOftenRarelySometimesFourth(t *testing.T) {
