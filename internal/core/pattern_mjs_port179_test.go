...
func TestMJS_Port179_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port179_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port179_FastSlowEarlyLateFourth(t *testing.T) {
