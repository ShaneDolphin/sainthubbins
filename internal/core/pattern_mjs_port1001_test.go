...
func TestMJS_Port1001_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1001_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1001_ArpChunkDegradeFourth(t *testing.T) {
