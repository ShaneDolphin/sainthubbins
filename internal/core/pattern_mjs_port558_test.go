...
func TestMJS_Port558_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port558_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port558_DegradeOftenRarelySometimesFourth(t *testing.T) {
