...
func TestMJS_Port1036_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1036_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1036_FastSlowEarlyLateFourth(t *testing.T) {
