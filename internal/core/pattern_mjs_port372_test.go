...
func TestMJS_Port372_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port372_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port372_ArpChunkDegradeFourth(t *testing.T) {
