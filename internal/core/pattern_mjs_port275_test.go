...
func TestMJS_Port275_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port275_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port275_HapSpanTimeValueFourth(t *testing.T) {
