...
func TestMJS_Port452_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port452_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port452_ArpChunkDegradeFourth(t *testing.T) {
