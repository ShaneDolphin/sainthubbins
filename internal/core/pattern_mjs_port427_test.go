...
func TestMJS_Port427_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port427_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port427_FastSlowEarlyLateFourth(t *testing.T) {
