...
func TestMJS_Port489_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port489_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port489_FastSlowEarlyLateFourth(t *testing.T) {
