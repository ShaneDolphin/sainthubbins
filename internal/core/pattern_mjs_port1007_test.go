...
func TestMJS_Port1007_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1007_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1007_ArpChunkDegradeFourth(t *testing.T) {
