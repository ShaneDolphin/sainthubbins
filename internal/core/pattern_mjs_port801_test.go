...
func TestMJS_Port801_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port801_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port801_ArpChunkDegradeFourth(t *testing.T) {
