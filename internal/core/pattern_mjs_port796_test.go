...
func TestMJS_Port796_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port796_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port796_ArpChunkDegradeFourth(t *testing.T) {
