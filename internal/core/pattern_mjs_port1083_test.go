...
func TestMJS_Port1083_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1083_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1083_HapSpanTimeValueFourth(t *testing.T) {
