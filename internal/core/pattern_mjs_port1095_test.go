...
func TestMJS_Port1095_SlowFastCompressZoomFourth(t *testing.T) {
...
func TestMJS_Port1095_EuclidSqueezeWithValueFourth(t *testing.T) {
...
func TestMJS_Port1095_JuxRevBrakHurryFourth(t *testing.T) {
