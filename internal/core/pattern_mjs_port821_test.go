...
func TestMJS_Port821_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port821_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port821_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
