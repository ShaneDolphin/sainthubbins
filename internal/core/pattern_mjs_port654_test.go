...
func TestMJS_Port654_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port654_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port654_DegradeOftenRarelySometimesFourth(t *testing.T) {
