...
func TestMJS_Port805_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port805_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port805_ArpChunkDegradeFourth(t *testing.T) {
