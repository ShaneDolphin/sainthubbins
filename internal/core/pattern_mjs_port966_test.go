...
func TestMJS_Port966_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port966_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port966_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
