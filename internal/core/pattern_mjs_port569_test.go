...
func TestMJS_Port569_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port569_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port569_DegradeOftenRarelySometimesFourth(t *testing.T) {
