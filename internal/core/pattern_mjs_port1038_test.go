...
func TestMJS_Port1038_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1038_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1038_FastSlowEarlyLateFourth(t *testing.T) {
