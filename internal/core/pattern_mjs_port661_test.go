...
func TestMJS_Port661_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port661_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port661_DegradeOftenRarelySometimesFourth(t *testing.T) {
