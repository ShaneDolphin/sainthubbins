...
func TestMJS_Port1008_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1008_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1008_ArpChunkDegradeFourth(t *testing.T) {
