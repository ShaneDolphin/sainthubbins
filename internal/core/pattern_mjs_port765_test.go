...
func TestMJS_Port765_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port765_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port765_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
