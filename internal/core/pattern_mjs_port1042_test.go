...
func TestMJS_Port1042_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1042_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1042_FastSlowEarlyLateFourth(t *testing.T) {
