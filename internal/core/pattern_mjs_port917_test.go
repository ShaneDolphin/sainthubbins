...
func TestMJS_Port917_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port917_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port917_DegradeOftenRarelySometimesFourth(t *testing.T) {
