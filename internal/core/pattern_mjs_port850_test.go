...
func TestMJS_Port850_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port850_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port850_FastSlowEarlyLateFourth(t *testing.T) {
