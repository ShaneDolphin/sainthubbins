...
func TestMJS_Port561_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port561_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port561_DegradeOftenRarelySometimesFourth(t *testing.T) {
