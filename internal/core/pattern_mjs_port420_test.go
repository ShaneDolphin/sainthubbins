...
func TestMJS_Port420_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port420_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port420_FastSlowEarlyLateFourth(t *testing.T) {
