...
func TestMJS_Port961_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port961_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port961_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
