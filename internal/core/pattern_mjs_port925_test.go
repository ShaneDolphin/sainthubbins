...
func TestMJS_Port925_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port925_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port925_DegradeOftenRarelySometimesFourth(t *testing.T) {
