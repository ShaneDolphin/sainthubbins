...
func TestMJS_Port809_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port809_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port809_ArpChunkDegradeFourth(t *testing.T) {
