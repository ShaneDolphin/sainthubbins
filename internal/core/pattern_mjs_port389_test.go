...
func TestMJS_Port389_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port389_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port389_ArpChunkDegradeFourth(t *testing.T) {
