...
func TestMJS_Port844_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port844_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port844_FastSlowEarlyLateFourth(t *testing.T) {
