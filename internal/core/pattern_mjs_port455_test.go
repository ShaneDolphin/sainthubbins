...
func TestMJS_Port455_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port455_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port455_ArpChunkDegradeFourth(t *testing.T) {
