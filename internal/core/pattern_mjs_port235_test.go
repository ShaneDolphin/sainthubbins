...
func TestMJS_Port235_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port235_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port235_ArpChunkDegradeFourth(t *testing.T) {
