...
func TestMJS_Port560_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port560_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port560_DegradeOftenRarelySometimesFourth(t *testing.T) {
