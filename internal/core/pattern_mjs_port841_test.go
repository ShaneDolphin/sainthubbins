...
func TestMJS_Port841_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port841_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port841_FastSlowEarlyLateFourth(t *testing.T) {
