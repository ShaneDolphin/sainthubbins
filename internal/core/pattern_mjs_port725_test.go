...
func TestMJS_Port725_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port725_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port725_DegradeOftenRarelySometimesFourth(t *testing.T) {
