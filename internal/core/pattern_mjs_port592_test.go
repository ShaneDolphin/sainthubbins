...
func TestMJS_Port592_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port592_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port592_FastSlowEarlyLateFourth(t *testing.T) {
