...
func TestMJS_Port669_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port669_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port669_DegradeOftenRarelySometimesFourth(t *testing.T) {
