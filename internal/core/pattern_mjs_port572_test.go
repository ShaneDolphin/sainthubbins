...
func TestMJS_Port572_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port572_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port572_DegradeOftenRarelySometimesFourth(t *testing.T) {
