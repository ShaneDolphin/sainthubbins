...
func TestMJS_Port814_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port814_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port814_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
