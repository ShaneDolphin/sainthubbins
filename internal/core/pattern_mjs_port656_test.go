...
func TestMJS_Port656_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port656_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port656_DegradeOftenRarelySometimesFourth(t *testing.T) {
