...
func TestMJS_Port963_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port963_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port963_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
