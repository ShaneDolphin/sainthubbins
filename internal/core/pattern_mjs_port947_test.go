...
func TestMJS_Port947_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port947_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port947_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
