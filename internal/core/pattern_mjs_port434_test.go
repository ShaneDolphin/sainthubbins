...
func TestMJS_Port434_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port434_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port434_ArpChunkDegradeFourth(t *testing.T) {
