...
func TestMJS_Port397_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port397_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port397_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
