...
func TestMJS_Port760_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port760_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port760_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
