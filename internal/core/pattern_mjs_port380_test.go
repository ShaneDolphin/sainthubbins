...
func TestMJS_Port380_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port380_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port380_ArpChunkDegradeFourth(t *testing.T) {
