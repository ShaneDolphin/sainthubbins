...
func TestMJS_Port1091_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1091_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1091_HapSpanTimeValueFourth(t *testing.T) {
