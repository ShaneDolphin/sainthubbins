...
func TestMJS_Port396_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port396_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port396_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
