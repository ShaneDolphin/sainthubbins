...
func TestMJS_Port916_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port916_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port916_DegradeOftenRarelySometimesFourth(t *testing.T) {
