...
func TestMJS_Port300_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port300_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port300_DegradeOftenRarelySometimesFourth(t *testing.T) {
