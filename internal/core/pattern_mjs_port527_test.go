...
func TestMJS_Port527_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port527_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port527_HapSpanTimeValueFourth(t *testing.T) {
