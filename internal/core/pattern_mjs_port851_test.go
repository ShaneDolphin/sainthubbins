...
func TestMJS_Port851_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port851_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port851_FastSlowEarlyLateFourth(t *testing.T) {
