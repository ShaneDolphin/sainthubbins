...
func TestMJS_Port840_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port840_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port840_FastSlowEarlyLateFourth(t *testing.T) {
