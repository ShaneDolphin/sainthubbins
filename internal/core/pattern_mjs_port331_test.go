...
func TestMJS_Port331_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port331_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port331_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
