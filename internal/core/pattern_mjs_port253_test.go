...
func TestMJS_Port253_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port253_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port253_FastSlowEarlyLateFourth(t *testing.T) {
