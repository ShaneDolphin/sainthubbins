...
func TestMJS_Port181_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port181_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port181_HapSpanTimeValueFourth(t *testing.T) {
