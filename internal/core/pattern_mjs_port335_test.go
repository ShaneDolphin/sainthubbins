...
func TestMJS_Port335_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port335_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port335_FastSlowEarlyLateFourth(t *testing.T) {
