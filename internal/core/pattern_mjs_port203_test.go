...
func TestMJS_Port203_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port203_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port203_FastSlowEarlyLateFourth(t *testing.T) {
