...
func TestMJS_Port843_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port843_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port843_FastSlowEarlyLateFourth(t *testing.T) {
