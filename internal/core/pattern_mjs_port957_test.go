...
func TestMJS_Port957_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port957_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port957_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
