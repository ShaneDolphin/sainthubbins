...
func TestMJS_Port579_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port579_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port579_FastSlowEarlyLateFourth(t *testing.T) {
