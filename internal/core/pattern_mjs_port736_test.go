...
func TestMJS_Port736_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port736_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port736_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
