...
func TestMJS_Port471_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port471_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port471_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
