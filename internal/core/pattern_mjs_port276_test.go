...
func TestMJS_Port276_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port276_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port276_HapSpanTimeValueFourth(t *testing.T) {
