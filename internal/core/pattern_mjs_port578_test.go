...
func TestMJS_Port578_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port578_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port578_FastSlowEarlyLateFourth(t *testing.T) {
