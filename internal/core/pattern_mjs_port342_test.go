...
func TestMJS_Port342_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port342_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port342_ArpChunkDegradeFourth(t *testing.T) {
