...
func TestMJS_Port827_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port827_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port827_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
