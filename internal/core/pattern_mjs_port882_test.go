...
func TestMJS_Port882_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port882_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port882_HapSpanTimeValueFourth(t *testing.T) {
