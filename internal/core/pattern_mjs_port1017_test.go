...
func TestMJS_Port1017_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port1017_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port1017_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
