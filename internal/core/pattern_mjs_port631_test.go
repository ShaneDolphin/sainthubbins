...
func TestMJS_Port631_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port631_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port631_HapSpanTimeValueFourth(t *testing.T) {
