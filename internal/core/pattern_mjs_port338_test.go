...
func TestMJS_Port338_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port338_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port338_FastSlowEarlyLateFourth(t *testing.T) {
