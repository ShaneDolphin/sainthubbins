...
func TestMJS_Port242_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port242_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port242_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
