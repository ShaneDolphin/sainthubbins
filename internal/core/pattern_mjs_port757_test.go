...
func TestMJS_Port757_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port757_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port757_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
