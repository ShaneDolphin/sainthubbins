...
func TestMJS_Port398_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port398_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port398_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
