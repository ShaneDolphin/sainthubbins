...
func TestMJS_Port387_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port387_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port387_ArpChunkDegradeFourth(t *testing.T) {
