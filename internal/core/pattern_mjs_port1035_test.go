...
func TestMJS_Port1035_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1035_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1035_FastSlowEarlyLateFourth(t *testing.T) {
