...
func TestMJS_Port351_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port351_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port351_HapSpanTimeValueFourth(t *testing.T) {
