...
func TestMJS_Port630_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port630_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port630_HapSpanTimeValueFourth(t *testing.T) {
