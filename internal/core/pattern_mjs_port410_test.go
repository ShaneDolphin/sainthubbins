...
func TestMJS_Port410_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port410_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port410_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
