...
func TestMJS_Port217_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port217_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port217_DegradeOftenRarelySometimesFourth(t *testing.T) {
