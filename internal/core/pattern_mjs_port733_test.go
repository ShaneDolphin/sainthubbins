...
func TestMJS_Port733_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port733_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port733_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
