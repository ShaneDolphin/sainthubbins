...
func TestMJS_Port838_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port838_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port838_FastSlowEarlyLateFourth(t *testing.T) {
