...
func TestMJS_Port459_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port459_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port459_ArpChunkDegradeFourth(t *testing.T) {
