...
func TestMJS_Port613_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port613_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port613_HapSpanTimeValueFourth(t *testing.T) {
