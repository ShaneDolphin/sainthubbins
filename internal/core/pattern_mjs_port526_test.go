...
func TestMJS_Port526_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port526_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port526_HapSpanTimeValueFourth(t *testing.T) {
