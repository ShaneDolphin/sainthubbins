...
func TestMJS_Port315_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port315_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port315_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
