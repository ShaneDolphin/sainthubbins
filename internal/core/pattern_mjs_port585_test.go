...
func TestMJS_Port585_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port585_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port585_FastSlowEarlyLateFourth(t *testing.T) {
