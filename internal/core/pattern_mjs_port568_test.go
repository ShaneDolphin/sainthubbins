...
func TestMJS_Port568_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port568_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port568_DegradeOftenRarelySometimesFourth(t *testing.T) {
