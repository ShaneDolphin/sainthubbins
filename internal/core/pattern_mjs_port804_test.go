...
func TestMJS_Port804_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port804_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port804_ArpChunkDegradeFourth(t *testing.T) {
