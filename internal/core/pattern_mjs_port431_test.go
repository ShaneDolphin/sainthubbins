...
func TestMJS_Port431_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port431_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port431_ArpChunkDegradeFourth(t *testing.T) {
