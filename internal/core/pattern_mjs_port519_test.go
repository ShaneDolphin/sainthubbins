...
func TestMJS_Port519_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port519_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port519_HapSpanTimeValueFourth(t *testing.T) {
