...
func TestMJS_Port347_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port347_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port347_FastSlowEarlyLateFourth(t *testing.T) {
