...
func TestMJS_Port1033_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1033_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1033_FastSlowEarlyLateFourth(t *testing.T) {
