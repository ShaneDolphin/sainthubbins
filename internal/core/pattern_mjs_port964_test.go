...
func TestMJS_Port964_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port964_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port964_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
