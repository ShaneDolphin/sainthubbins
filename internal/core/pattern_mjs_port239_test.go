...
func TestMJS_Port239_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port239_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port239_ArpChunkDegradeFourth(t *testing.T) {
