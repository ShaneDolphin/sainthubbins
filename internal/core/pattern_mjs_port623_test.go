...
func TestMJS_Port623_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port623_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port623_HapSpanTimeValueFourth(t *testing.T) {
