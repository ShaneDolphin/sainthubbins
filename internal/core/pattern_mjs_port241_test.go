...
func TestMJS_Port241_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port241_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port241_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
