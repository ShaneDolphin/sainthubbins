...
func TestMJS_Port836_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port836_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port836_FastSlowEarlyLateFourth(t *testing.T) {
