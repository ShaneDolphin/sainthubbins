...
func TestMJS_Port482_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port482_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port482_FastSlowEarlyLateFourth(t *testing.T) {
