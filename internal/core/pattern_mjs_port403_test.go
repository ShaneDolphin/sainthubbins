...
func TestMJS_Port403_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port403_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port403_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
