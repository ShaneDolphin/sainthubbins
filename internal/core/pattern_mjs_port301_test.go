...
func TestMJS_Port301_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port301_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port301_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
