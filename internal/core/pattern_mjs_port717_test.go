...
func TestMJS_Port717_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port717_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port717_DegradeOftenRarelySometimesFourth(t *testing.T) {
