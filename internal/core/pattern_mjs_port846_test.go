...
func TestMJS_Port846_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port846_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port846_FastSlowEarlyLateFourth(t *testing.T) {
