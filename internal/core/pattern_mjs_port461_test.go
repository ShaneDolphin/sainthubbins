...
func TestMJS_Port461_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port461_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port461_ArpChunkDegradeFourth(t *testing.T) {
