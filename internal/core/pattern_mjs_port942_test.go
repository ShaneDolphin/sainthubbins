...
func TestMJS_Port942_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port942_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port942_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
