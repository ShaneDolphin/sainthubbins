...
func TestMJS_Port770_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port770_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port770_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
