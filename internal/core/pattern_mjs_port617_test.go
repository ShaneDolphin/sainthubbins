...
func TestMJS_Port617_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port617_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port617_HapSpanTimeValueFourth(t *testing.T) {
