...
func TestMJS_Port225_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port225_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port225_HapSpanTimeValueFourth(t *testing.T) {
