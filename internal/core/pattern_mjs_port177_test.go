...
func TestMJS_Port177_StackCatFastSlowFourth(t *testing.T) {
	...
	if len(s.QueryArc(FractionFromInt(0), FractionFromInt(2))) != 1 {
		t.Fatalf("Slow 2")
	}
}

func TestMJS_Port177_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port177_ArpChunkDegradeFourth(t *testing.T) {
