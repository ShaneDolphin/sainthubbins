...
func TestMJS_Port450_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port450_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port450_ArpChunkDegradeFourth(t *testing.T) {
