...
func TestMJS_Port530_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port530_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port530_HapSpanTimeValueFourth(t *testing.T) {
