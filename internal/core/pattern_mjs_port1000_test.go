...
func TestMJS_Port1000_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1000_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1000_ArpChunkDegradeFourth(t *testing.T) {
