...
func TestMJS_Port1088_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1088_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1088_HapSpanTimeValueFourth(t *testing.T) {
