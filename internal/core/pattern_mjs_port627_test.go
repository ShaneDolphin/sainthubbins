...
func TestMJS_Port627_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port627_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port627_HapSpanTimeValueFourth(t *testing.T) {
