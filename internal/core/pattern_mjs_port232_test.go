...
func TestMJS_Port232_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port232_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port232_ArpChunkDegradeFourth(t *testing.T) {
