...
func TestMJS_Port250_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port250_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port250_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
