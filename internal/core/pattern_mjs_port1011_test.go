...
func TestMJS_Port1011_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1011_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1011_ArpChunkDegradeFourth(t *testing.T) {
