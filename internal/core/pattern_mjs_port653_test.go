...
func TestMJS_Port653_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port653_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port653_DegradeOftenRarelySometimesFourth(t *testing.T) {
