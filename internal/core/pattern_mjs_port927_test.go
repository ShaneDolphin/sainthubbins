...
func TestMJS_Port927_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port927_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port927_DegradeOftenRarelySometimesFourth(t *testing.T) {
