...
func TestMJS_Port719_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port719_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port719_DegradeOftenRarelySometimesFourth(t *testing.T) {
