...
func TestMJS_Port344_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port344_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port344_FastSlowEarlyLateFourth(t *testing.T) {
