...
func TestMJS_Port586_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port586_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port586_FastSlowEarlyLateFourth(t *testing.T) {
