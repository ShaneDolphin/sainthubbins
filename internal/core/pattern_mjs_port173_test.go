...
func TestMJS_Port173_SignalSineTriSawFourth(t *testing.T) {
...
func TestMJS_Port173_PatternWhenWithOffFourth(t *testing.T) {
...
func TestMJS_Port173_HapContextWithValueFourth(t *testing.T) {
