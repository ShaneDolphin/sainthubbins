...
func TestMJS_Port445_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port445_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port445_ArpChunkDegradeFourth(t *testing.T) {
