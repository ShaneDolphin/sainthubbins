...
func TestMJS_Port621_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port621_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port621_HapSpanTimeValueFourth(t *testing.T) {
