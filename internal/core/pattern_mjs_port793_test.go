...
func TestMJS_Port793_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port793_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port793_ArpChunkDegradeFourth(t *testing.T) {
