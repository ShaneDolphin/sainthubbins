...
func TestMJS_Port251_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port251_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port251_FastSlowEarlyLateFourth(t *testing.T) {
