...
func TestMJS_Port812_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port812_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port812_ArpChunkDegradeFourth(t *testing.T) {
