...
func TestMJS_Port887_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port887_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port887_HapSpanTimeValueFourth(t *testing.T) {
