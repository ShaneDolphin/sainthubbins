...
func TestMJS_Port448_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port448_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port448_ArpChunkDegradeFourth(t *testing.T) {
