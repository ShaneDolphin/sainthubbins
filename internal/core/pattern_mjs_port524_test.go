...
func TestMJS_Port524_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port524_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port524_HapSpanTimeValueFourth(t *testing.T) {
