...
func TestMJS_Port390_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port390_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port390_ArpChunkDegradeFourth(t *testing.T) {
