...
func TestMJS_Port713_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port713_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port713_DegradeOftenRarelySometimesFourth(t *testing.T) {
