...
func TestMJS_Port446_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port446_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port446_ArpChunkDegradeFourth(t *testing.T) {
