...
func TestMJS_Port439_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port439_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port439_ArpChunkDegradeFourth(t *testing.T) {
