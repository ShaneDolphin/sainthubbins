...
func TestMJS_Port920_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port920_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port920_DegradeOftenRarelySometimesFourth(t *testing.T) {
