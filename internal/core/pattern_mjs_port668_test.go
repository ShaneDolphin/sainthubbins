...
func TestMJS_Port668_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port668_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port668_DegradeOftenRarelySometimesFourth(t *testing.T) {
