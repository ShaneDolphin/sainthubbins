...
func TestMJS_Port314_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port314_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port314_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
