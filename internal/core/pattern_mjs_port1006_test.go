...
func TestMJS_Port1006_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port1006_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port1006_ArpChunkDegradeFourth(t *testing.T) {
