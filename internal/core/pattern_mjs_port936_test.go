...
func TestMJS_Port936_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port936_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port936_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
