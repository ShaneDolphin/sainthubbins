...
func TestMJS_Port433_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port433_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port433_ArpChunkDegradeFourth(t *testing.T) {
