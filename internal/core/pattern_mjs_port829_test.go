...
func TestMJS_Port829_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port829_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port829_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
