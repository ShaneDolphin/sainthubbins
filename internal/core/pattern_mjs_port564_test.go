...
func TestMJS_Port564_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port564_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port564_DegradeOftenRarelySometimesFourth(t *testing.T) {
