...
func TestMJS_Port1041_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1041_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1041_FastSlowEarlyLateFourth(t *testing.T) {
