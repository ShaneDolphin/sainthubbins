...
func TestMJS_Port1096_SlowFastCompressZoomFourth(t *testing.T) {
...
func TestMJS_Port1096_EuclidSqueezeWithValueFourth(t *testing.T) {
...
func TestMJS_Port1096_JuxRevBrakHurryFourth(t *testing.T) {
