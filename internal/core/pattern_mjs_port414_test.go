...
func TestMJS_Port414_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port414_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port414_FastSlowEarlyLateFourth(t *testing.T) {
