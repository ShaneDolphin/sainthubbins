...
func TestMJS_Port720_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port720_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port720_DegradeOftenRarelySometimesFourth(t *testing.T) {
