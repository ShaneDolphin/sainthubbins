...
func TestMJS_Port965_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port965_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port965_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
