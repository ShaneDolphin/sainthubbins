...
func TestMJS_Port520_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port520_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port520_HapSpanTimeValueFourth(t *testing.T) {
