...
func TestMJS_Port625_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port625_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port625_HapSpanTimeValueFourth(t *testing.T) {
