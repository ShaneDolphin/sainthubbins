...
func TestMJS_Port407_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port407_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port407_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
