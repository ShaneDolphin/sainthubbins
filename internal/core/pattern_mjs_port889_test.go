...
func TestMJS_Port889_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port889_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port889_HapSpanTimeValueFourth(t *testing.T) {
