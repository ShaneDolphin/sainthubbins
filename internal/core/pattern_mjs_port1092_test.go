...
func TestMJS_Port1092_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port1092_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port1092_HapSpanTimeValueFourth(t *testing.T) {
