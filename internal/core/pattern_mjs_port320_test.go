...
func TestMJS_Port320_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port320_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port320_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
