...
func TestMJS_Port201_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port201_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port201_ArpChunkDegradeFourth(t *testing.T) {
