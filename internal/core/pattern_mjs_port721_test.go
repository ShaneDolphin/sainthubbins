...
func TestMJS_Port721_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port721_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port721_DegradeOftenRarelySometimesFourth(t *testing.T) {
