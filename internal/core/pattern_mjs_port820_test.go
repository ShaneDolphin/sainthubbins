...
func TestMJS_Port820_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port820_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port820_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
