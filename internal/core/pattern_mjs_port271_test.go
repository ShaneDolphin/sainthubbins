...
func TestMJS_Port271_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port271_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port271_HapSpanTimeValueFourth(t *testing.T) {
