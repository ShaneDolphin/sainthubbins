...
func TestMJS_Port1040_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1040_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1040_FastSlowEarlyLateFourth(t *testing.T) {
