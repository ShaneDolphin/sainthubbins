...
func TestMJS_Port419_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port419_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port419_FastSlowEarlyLateFourth(t *testing.T) {
