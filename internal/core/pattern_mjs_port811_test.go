...
func TestMJS_Port811_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port811_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port811_ArpChunkDegradeFourth(t *testing.T) {
