...
func TestMJS_Port571_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port571_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port571_DegradeOftenRarelySometimesFourth(t *testing.T) {
