...
func TestMJS_Port292_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port292_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port292_DegradeOftenRarelySometimesFourth(t *testing.T) {
