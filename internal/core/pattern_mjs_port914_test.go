...
func TestMJS_Port914_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port914_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port914_DegradeOftenRarelySometimesFourth(t *testing.T) {
