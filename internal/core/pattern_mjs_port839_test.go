...
func TestMJS_Port839_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port839_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port839_FastSlowEarlyLateFourth(t *testing.T) {
