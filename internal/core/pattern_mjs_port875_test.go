...
func TestMJS_Port875_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port875_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port875_HapSpanTimeValueFourth(t *testing.T) {
