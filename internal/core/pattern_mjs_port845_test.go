...
func TestMJS_Port845_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port845_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port845_FastSlowEarlyLateFourth(t *testing.T) {
