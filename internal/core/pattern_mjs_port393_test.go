...
func TestMJS_Port393_InsideOutsideRevHurryFourth(t *testing.T) {
...
func TestMJS_Port393_EuclidBjorklundStructFourth(t *testing.T) {
...
func TestMJS_Port393_ControlsGainPanCutoffFourth(t *testing.T) {
	p := S("bd").Set(Gain(0.9))
