...
func TestMJS_Port659_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port659_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port659_DegradeOftenRarelySometimesFourth(t *testing.T) {
