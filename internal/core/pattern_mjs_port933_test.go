...
func TestMJS_Port933_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port933_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port933_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
