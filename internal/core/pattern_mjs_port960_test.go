...
func TestMJS_Port960_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port960_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port960_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
