...
func TestMJS_Port357_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port357_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port357_HapSpanTimeValueFourth(t *testing.T) {
