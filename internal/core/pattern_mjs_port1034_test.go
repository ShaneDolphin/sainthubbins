...
func TestMJS_Port1034_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port1034_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port1034_FastSlowEarlyLateFourth(t *testing.T) {
