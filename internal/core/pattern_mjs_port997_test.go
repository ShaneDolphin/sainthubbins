...
func TestMJS_Port997_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port997_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port997_ArpChunkDegradeFourth(t *testing.T) {
