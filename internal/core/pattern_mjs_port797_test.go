...
func TestMJS_Port797_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port797_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port797_ArpChunkDegradeFourth(t *testing.T) {
