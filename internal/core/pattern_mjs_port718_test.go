...
func TestMJS_Port718_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port718_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port718_DegradeOftenRarelySometimesFourth(t *testing.T) {
