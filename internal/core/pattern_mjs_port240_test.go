...
func TestMJS_Port240_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port240_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port240_ArpChunkDegradeFourth(t *testing.T) {
