...
func TestMJS_Port388_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port388_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port388_ArpChunkDegradeFourth(t *testing.T) {
