...
func TestMJS_Port950_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port950_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port950_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
