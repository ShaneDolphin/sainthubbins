...
func TestMJS_Port280_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port280_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port280_HapSpanTimeValueFourth(t *testing.T) {
