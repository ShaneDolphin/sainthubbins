...
func TestMJS_Port730_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port730_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port730_DegradeOftenRarelySometimesFourth(t *testing.T) {
