...
func TestMJS_Port729_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port729_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port729_DegradeOftenRarelySometimesFourth(t *testing.T) {
