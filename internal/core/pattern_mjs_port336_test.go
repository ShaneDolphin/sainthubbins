...
func TestMJS_Port336_StackCatFastSlowFourth(t *testing.T) {
...
func TestMJS_Port336_SignalRangePerlinFourth(t *testing.T) {
	s := Sine().Range(-1, 1)
...
func TestMJS_Port336_ArpChunkDegradeFourth(t *testing.T) {
