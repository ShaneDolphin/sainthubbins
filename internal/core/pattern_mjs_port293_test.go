...
func TestMJS_Port293_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port293_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port293_DegradeOftenRarelySometimesFourth(t *testing.T) {
