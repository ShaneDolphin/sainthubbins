...
func TestMJS_Port741_EveryOffWhenChunkFourth(t *testing.T) {
...
func TestMJS_Port741_ScaleChordTransposeFourth(t *testing.T) {
...
func TestMJS_Port741_PatternAddMulDivModFourth(t *testing.T) {
	p := Pure(3).Add(Pure(4))
