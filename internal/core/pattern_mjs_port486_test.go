...
func TestMJS_Port486_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port486_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port486_FastSlowEarlyLateFourth(t *testing.T) {
