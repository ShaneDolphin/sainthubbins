...
func TestMJS_Port884_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port884_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port884_HapSpanTimeValueFourth(t *testing.T) {
