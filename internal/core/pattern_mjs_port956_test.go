...
func TestMJS_Port956_FastCatSlowCatSequenceArpFourth(t *testing.T) {
...
func TestMJS_Port956_InsideOutsideWithSlowFastFourth(t *testing.T) {
...
func TestMJS_Port956_ControlsNoteCutoffRoomFourth(t *testing.T) {
	n := Note("c3")
