...
func TestMJS_Port478_CompressZoomWithinSegmentFourth(t *testing.T) {
...
func TestMJS_Port478_EveryWhenOffSometimesFourth(t *testing.T) {
...
func TestMJS_Port478_FastSlowEarlyLateFourth(t *testing.T) {
