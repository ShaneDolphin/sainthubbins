...
func TestMJS_Port369_RandChooseDegradeShuffleFourth(t *testing.T) {
	r := Rand().Range(0, 1)
...
func TestMJS_Port369_MultiMapWithValueSFourth(t *testing.T) {
...
func TestMJS_Port369_HapSpanTimeValueFourth(t *testing.T) {
