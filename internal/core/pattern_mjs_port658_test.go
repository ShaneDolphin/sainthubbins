...
func TestMJS_Port658_StackWithSStackAmpersandFourth(t *testing.T) {
...
func TestMJS_Port658_SignalTriSawRandPerlinFourth(t *testing.T) {
	tri := Tri().Range(-1, 1)
...
func TestMJS_Port658_DegradeOftenRarelySometimesFourth(t *testing.T) {
